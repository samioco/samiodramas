...
<tr><td class="boldText" width="25" align="center">#</td>
<td class="boldText" width="150" align="center">Ep. Type</td>
...
for ($i=1;$i<=4;$i++) {
	...
	while (($target_str_startpos>0)) {
		...
		*/
		...
		?><tr><td><?echo $j;?></td>
		<td><input type="text" size="10" name="eps_type[<?echo $j;?>]" value="<?echo $eps_type;?>"></td>
		...
		<td><input type="text" size="5" name="last[<?echo $j;?>]" value="<?echo "0";?>"></td>
...
?><tr><td align="center" width="100%" valign="top" colspan="7">
